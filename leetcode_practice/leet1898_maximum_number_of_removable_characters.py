...
indices of s (s is also 0-indexed). You want to choose an integer k
...
class Solution:
    def maximumRemovals(self, s: str, p: str, removable: List[int]) -> int:
        ...
        while l <= r:
            m = (l + r) // 2
            removed = set(removable[:m+1])  #position that removed from s
            if isSubseq(s, p):
...
# expected output: 2
"""
Explanation: After removing the characters at indices 3 and 1, "abcacb" becomes
"accb". "ab" is a subsequence of "accb".
